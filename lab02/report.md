...
![Создала пользователя guest](image/01.png){ #fig:001 width=70% }
...
5.	Уточнили имя пользователя, его группу, а также группы, куда входит пользователь, командой id. Выведенные значения uid, gid и др. Сравнили вывод id с выводом команды groups. Видим, что gid и группы = 501(guest)

![Команда id и groups](image/05.png){ #fig:005 width=70% }
...
![Информация о пользователе guest](image/05.png)

7.	Просмотрим файл /etc/passwd Командой: cat /etc/passwd. Найдем в нём свою учётную запись. Определим uid пользователя. Определим gid пользователя. Сравним найденные значения с полученными в предыдущих пунктах. Guest имеет те же идентификаторы 501, наш пользователь под идентификатором 500.

![Сожержимое файла /etc/passwd](image/06.png){ #fig:006 width=70% }

8.	Определим существующие в системе директории командой ls -l /home/

![Команда ls -l /home/](image/07.png){ #fig:007 width=70% }
...
![Расширенные атрибуты](image/08.png){ #fig:008 width=70% }
...
![Снятие атрибутов с директории](image/09.png){ #fig:009 width=70% }
